...
@media only screen and (max-width: 480px) {
  ...
  <body style="word-spacing:normal;background-color:{{ config('enso.mails.layout.background') }};">
    ...
    <div style="display:none;font-size:1px;color:#ffffff;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;">{{ config('enso.mails.brand.name') }}</div>
      ...
      <!--[if mso | IE]><table align="center" border="0" cellpadding="0" cellspacing="0" class="enso-mail-card-outlook" role="presentation" style="width:600px;" width="600" bgcolor="{{ config('enso.mails.layout.surface') }}" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]-->
    
      
      <div class="enso-mail-card" style="width: calc(100% - 32px); box-shadow: 0 20px 48px rgba(32, 41, 56, .13), 0 2px 8px rgba(32, 41, 56, .06); background: {{ config('enso.mails.layout.surface') }}; background-color: {{ config('enso.mails.layout.surface') }}; margin: 0px auto; max-width: 600px; border-radius: {{ config('enso.mails.layout.card_radius') }}px; overflow: hidden;">
      ...
      @include('mail::header')
          <!--[if mso | IE]><tr><td class="enso-mail-content-section-outlook" width="600px" ><table align="center" border="0" cellpadding="0" cellspacing="0" class="enso-mail-content-section-outlook" role="presentation" style="width:598px;" width="598" bgcolor="{{ config('enso.mails.layout.surface') }}" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]-->
    
      
      <div class="enso-mail-content-section" style="background:{{ config('enso.mails.layout.surface') }};background-color:{{ config('enso.mails.layout.surface') }};margin:0px auto;max-width:598px;">
