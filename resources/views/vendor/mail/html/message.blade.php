...
<html lang="und" dir="auto" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  ...
  <body style="word-spacing:normal;background-color:{{ config('enso.mails.layout.background') }};">
    ...
    <div style="display:none;font-size:1px;color:#ffffff;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;">{{ config('enso.mails.brand.name') }}</div>
      ...
      @include('mail::header')
          <!--[if mso | IE]><tr><td class="" width="600px" ><table align="center" border="0" cellpadding="0" cellspacing="0" class="" role="presentation" style="width:598px;" width="598" bgcolor="{{ config('enso.mails.layout.surface') }}" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]-->
    
      
      <div style="background:{{ config('enso.mails.layout.surface') }};background-color:{{ config('enso.mails.layout.surface') }};margin:0px auto;max-width:598px;">
